...
class _TimelineScreenState extends State<TimelineScreen> {
  ...
  void _addToTimeline(List<Task> tasks, List<TimelineItem> existing) {
    ...
    if (available.isEmpty) {
      showAppSnackBar(context, 'Chưa có task nào để thêm vào timeline');
      return;
    }
            ...
            child: SingleChildScrollView(
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                TextField(
                  ...
                  style: const TextStyle(fontSize: 13, color: kTextMain),
                  decoration: appInputDecoration(labelText: 'Nhãn trạng thái', hintText: 'VD: Đang làm, Sắp tới...'),
                ),
                const SizedBox(height: 14),

                appDialogLabel('Bắt đầu từ tuần'),
                Wrap(
                  spacing: 8,
                ...
                appDialogLabel('Kéo dài (số tuần)'),
                Row(children: List.generate(_weeks.length - selStart, (i) {
                  final span = i + 1;
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: active ? [BoxShadow(color: c.color.withOpacity(0.5), blurRadius: 6)] : null,
                      ),
                    ),
                  );
                }).toList()),
                ...
                Container(
                  ...
                  child: Row(children: [
                    const Text('Xem trước: ', style: TextStyle(fontSize: 11, color: kTextMuted)),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.pop(ctx);
                showAppSnackBar(context, 'Đã thêm "${selectedTask.title}" vào timeline');
              },
